...
namespace EduQuest_Infrastructure.ExternalServices.Authentication;
...
public class JwtProvider : IJwtProvider
{
    ...
    public async Task<string> GenerateAccessToken(string email)
    {
        ...
        {
            new Claim(UserClaimType.UserId, existUser.Id.ToString()),
    ...
    //    var existUser = await _refreshTokenRepository.GetUserByIdAsync(userIdClaim!.Value.ToString());
    ...
    //        if (existingRefreshToken != null && existingRefreshToken.ExpireAt <= DateTime.UtcNow)
    //        {
    //            await _refreshTokenRepository.Delete(existingRefreshToken.Token);
    //        }
    //        return new APIResponse
    //        {
    //            IsError = true,
