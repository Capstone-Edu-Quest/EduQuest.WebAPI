...
namespace EduQuest_Infrastructure.Migrations
{
    ...
    [Migration("20250520160449_ItemShards")]
    partial class ItemShards
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduQuest_Domain.Entities.AssignmentPeerReview", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");

                    b.Property<string>("AssignmentAttemptId")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("EduQuest_Domain.Entities.ItemShards", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("EduQuest_Domain.Entities.LessonContent", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("EduQuest_Domain.Entities.Option", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("EduQuest_Domain.Entities.Transaction", b =>
                {
                    ...
                    b.Property<string>("BaseTransactionId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("EduQuest_Domain.Entities.TransactionDetail", b =>
                {
                    ...
                    b.Property<string>("TransferGoup")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("EduQuest_Domain.Entities.User", b =>
                {
                    ...
                    b.Property<string>("AssignToExpertId")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("StripeAccountUrl")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("EduQuest_Domain.Entities.UserQuizAnswers", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("EduQuest_Domain.Entities.AssignmentAttempt", b =>
                {
                    ...
                    b.HasOne("EduQuest_Domain.Entities.Lesson", "Lesson")
                        .WithMany()
            ...
            modelBuilder.Entity("EduQuest_Domain.Entities.AssignmentPeerReview", b =>
                {
                    ...
                    b.Navigation("AssignmentAttempt");
                });
            ...
            modelBuilder.Entity("EduQuest_Domain.Entities.ItemShards", b =>
                {
                    b.HasOne("EduQuest_Domain.Entities.Tag", "Tags")
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EduQuest_Domain.Entities.LessonContent", b =>
                {
                    ...
                    b.HasOne("EduQuest_Domain.Entities.Material", "Material")
                        .WithMany("LessonMaterials")
            ...
            modelBuilder.Entity("EduQuest_Domain.Entities.UserQuizAnswers", b =>
                {
                    b.HasOne("EduQuest_Domain.Entities.Option", "Answer")
                        .WithMany()
                    ...
                    b.HasOne("EduQuest_Domain.Entities.QuizAttempt", null)
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("QuizTag", b =>
                {
                    b.HasOne("EduQuest_Domain.Entities.Quiz", null)
                        .WithMany()
