...
public class GetLearnerProfileQueryHandler : IRequestHandler<GetLearnerProfileQuery, APIResponse>
{
    ...
    public GetLearnerProfileQueryHandler(IUserRepository userRepository, ICourseRepository courseRepository, IStudyTimeRepository studyTimeRepository, ILearnerRepository learnerRepository, IMapper mapper)
    {
