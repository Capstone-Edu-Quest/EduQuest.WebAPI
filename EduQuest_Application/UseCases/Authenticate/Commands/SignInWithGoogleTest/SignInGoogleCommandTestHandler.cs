...
public class SignInGoogleCommandTestHandler : IRequestHandler<SignInGoogleCommandTest, APIResponse>
{
    ...
    public SignInGoogleCommandTestHandler(IUserRepository userRepository,
    ...
    public async Task<APIResponse> Handle(SignInGoogleCommandTest request, CancellationToken cancellationToken)
    {
